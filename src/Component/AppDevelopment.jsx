  ...
  return (
    <ThemeProvider theme={theme}>
      <Container maxWidth="2xl" disableGutters sx={{ overflow: "hidden" }}>
        <Box
          sx={{
            backgroundImage: `url('https://images.pexels.com/photos/1181406/pexels-photo-1181406.jpeg?auto=compress&cs=tinysrgb&w=600')`,
        ...
        >
          ...
          <Typography variant="p" sx={{ mt: "32rem", color: "black" }}>
            Unlock the Power of Web Presence with our Professional Website
            Designing <br />
            ...
            >
              ...
              <Box sx={{ flex: 1 }}>
                {[
                  ...
                  {
                    id: 2,
                    question: "Deployment and Launch",
                    answer:
                  ...
                  {
                    id: 3,
                    question: "Post-Launch Maintenance",
                    answer:
        ...
        <img
          ...
          sx={{xs:{height:'2rem',md:height:'23rem'}}
        />
      </Box> */}
              <Box sx={{ flex: 1, display: "flex", justifyContent: "center" }}>
                <Box
